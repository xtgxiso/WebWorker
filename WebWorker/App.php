...
class App extends Worker
{
    ...
    public function onClientMessage($connection,$data){
        if ( empty($this->map) ){
            $connection->send('<div style="margin: 200px auto;width:500px;height:800px;text-align:center;">基于<a href="http://www.workerman.net/" target="_blank">Workerman</a>实现的自带http server的web开发框架<br/>没有添加路由，请添加路由!</div>');
            return;
        }
